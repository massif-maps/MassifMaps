...
namespace {
    ...
    cglib::bbox3<double> calculateBounds(const massif::nml::Bounds3& bounds, const cglib::mat4x4<double>& matrix) {
    ...
    float calculateProjectedScreenSize(const massif::nml::Bounds3& bounds, const cglib::mat4x4<double>& frustumMVP) {
