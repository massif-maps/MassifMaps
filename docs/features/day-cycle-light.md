...
- Colours read `#rgb`, `#rgba`, `#rrggbb`, `#rrggbbaa` (alpha last, as in a style sheet), or a
  plain ARGB number — the same spellings every colour property takes. Written back as `#rrggbbaa`.
