...
| [`web-build.md`](web-build.md) | Building the SDK under emscripten: the `web/native` platform layer, the cross-origin-isolation and main-thread-GL rules, and what the wasm build does not carry yet |
