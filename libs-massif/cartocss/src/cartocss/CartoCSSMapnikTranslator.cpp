...
namespace massif::css {
    ...
    const std::unordered_map<std::string, std::string> CartoCSSMapnikTranslator::_symbolizerPropertyMap = {
        ...
        { "text-collision-padding", "collision-padding" },
        ...
        { "text-background-width", "background-width" },
        { "text-background-height", "background-height" },
        ...
        { "shield-background-width", "background-width" },
        { "shield-background-height", "background-height" },
        ...
        { "shield-icon-background-width", "icon-background-width" },
        { "shield-icon-background-height", "icon-background-height" },
        ...
        { "shield-collision-padding", "collision-padding" },
