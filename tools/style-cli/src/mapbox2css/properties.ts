...
export const KNOWN_GAPS: Record<string, string> = {
    ...
    // A text or shield label takes it as collision-padding; an icon-only layer is a marker,
    // which carries no collision box of its own.
    'icon-padding': 'an icon-only layer has no collision padding',
